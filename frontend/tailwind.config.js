    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 30px rgba(139, 115, 85, 0.5)' },
        },
        shimmer: {
      ...
      backgroundImage: {
        ...
        'gradient-accent': 'linear-gradient(45deg, #8B7355, #D2B48C, #F5DEB3, #E6D7C3)',
        'gradient-subtle': 'linear-gradient(90deg, #8B7355, #D2B48C, #F5DEB3, #E6D7C3)',
      },
    },
  },
  plugins: [],
